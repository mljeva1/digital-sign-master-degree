...
- `tests/Feature/ContractSnapshotTest.php` uses a hand-built simplified schema. It may validate application behavior, but it does not prove real migrations or PostgreSQL CHECK constraints.
